 ...
 */
public class NewClock2Activity extends BasicActivity implements EventListener {

    private MyDatabaseHelper dbHelper;
    private String clockTitle;
    private FloatingActionButton fab_ok;
    private EditText nv_clock_title;
    private static final String TAG = "NewClock2Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setStatusBar();
        setContentView(R.layout.activity_new_clock2);
        toolbar = (Toolbar) findViewById(R.id.new_clock_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayShowTitleEnabled(false);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        dbHelper = new MyDatabaseHelper(NewClock2Activity.this, "Data.db", null, 2);
    ...
    private void initView() {
        nv_clock_title = (EditText) findViewById(R.id.new_clock_title2);
        fab_ok = (FloatingActionButton) findViewById(R.id.fab_clock2);
        new_bg = (ImageView) findViewById(R.id.new_clock_bg2);
        mic_clock = (Button) findViewById(R.id.mic_clock2);
...
//                        .get(NewClock2Activity.this,"pref_key_work_length", ClockApplication.DEFAULT_WORK_LENGTH))
//                .build();
//        // 短时休息
//        (new SeekBarPreference(this))
...
//                .setUnit(R.string.pref_title_time_value)
//                .setProgress((int)SPUtils
//                        .get(NewClock2Activity.this,"pref_key_short_break", ClockApplication.DEFAULT_SHORT_BREAK))
//                .build();
//        // 长时休息
//        (new SeekBarPreference(this))
...
//                .setUnit(R.string.pref_title_time_value)
//                .setProgress((int)SPUtils
//                        .get(NewClock2Activity.this,"pref_key_long_break", ClockApplication.DEFAULT_LONG_BREAK))
//                .build();
//        // 长时休息间隔
//        (new SeekBarPreference(this))
...
//                .setProgress((int)SPUtils
//                        .get(NewClock2Activity.this,"pref_key_long_break_frequency", ClockApplication.DEFAULT_LONG_BREAK_FREQUENCY))
//                .build();
...
//                tomato.setFrequency(frequency);
                ...
                if(isSync){
                    if(NetWorkUtils.isNetworkConnected(getApplication()) && User.getCurrentUser(User.class)!= null){
                        tomato.save(new SaveListener<String>() {
                            ...
                            public void done(String s, BmobException e) {
                                if (e==null){
                                    ...
                                    id = db.insert("Clock2",null,values);
                        ...
                        Toasty.info(NewClock2Activity.this, "请先登录", Toast.LENGTH_SHORT, true).show();
                    }
...
//        params1.put(com.baidu.speech.asr.SpeechConstant.IN_FILE, Environment.getExternalStorageDirectory() + "/msc/baidu.wav");
    ...
    private void showVoiceDialog(){
        voice = new MaterialDialog(NewClock2Activity.this);
        LayoutInflater layoutInflater = LayoutInflater.from(NewClock2Activity.this);
