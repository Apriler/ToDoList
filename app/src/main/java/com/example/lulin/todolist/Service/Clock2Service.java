...
import com.example.lulin.todolist.Activity.Clock2Activity;
...
import com.example.lulin.todolist.Utils.CountUpTimer;
...
//    private CountDownTimer mTimer;
    ...
    public static Intent newIntent(Context context) {
        return new Intent(context, Clock2Service.class);
    }

    public Clock2Service() {
    }
...
//                    mTimer = new CountDownTimer(millsInTotal);
                    mTimer = new CountUpTimer(millsInTotal);
    ...
    @Override
    public void onCountUpTick(long millisUntilFinished) {
...
//            Intent i = ClockService.newIntent(getApplicationContext());
            Intent i = new Intent(getBaseContext(),Clock2Activity.class);
...
//        Intent intent = ClockActivity.newIntent(getApplicationContext());
        Intent intent = new Intent(getBaseContext(), Clock2Activity.class);
