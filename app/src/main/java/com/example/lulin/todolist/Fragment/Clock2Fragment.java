...
import com.example.lulin.todolist.Utils.Tomato2Utils;
...
public class Clock2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_clock2, container, false);
        layout = new LinearLayoutManager(getContext());
        recyclerView = (RecyclerView) rootView.findViewById(R.id.clock_recycler_view2);
    ...
    private void setDbData(){
        ...
        localTomato = Tomato2Utils.getAllTomato(getContext());
